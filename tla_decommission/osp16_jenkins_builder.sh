...
-e JENKINS_TOKEN="$I2_JENKINS_TOKEN" \
...
-e STK_ENDPOINT="$SVC_OSREFRESH_ENDPOINT" \
-e STK_TOKEN="$SVC_OSREFRESH_TOKEN" \
-e SCM_TYPE="gitlab" \
...
docker.app.betfair/cloud-automation/product/osp16_tla_decommission:almeidar3-test ./run_job.sh  | tee outputjob.txt
ecode=${PIPESTATUS[0]}
